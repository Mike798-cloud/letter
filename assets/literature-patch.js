(() => {
  ...
  const PATCH_VERSION = "2026-08-26-literary-people-6";
  ...
  const profileSupplements = {
    "赫尔曼·福格尔": [
      "他把准时看得近乎固执，却从不催别人。每天最早到邮局的人往往能看见他先烧一壶水，再去开退信柜；水壶总放在离抄写员桌更近的一侧。办公室抽屉里常年有备用鞋带、儿童铅笔和一小罐酸李子，东西不贵，却总在有人需要的时候刚好拿得出来。",
      "赫尔曼说话慢，尤其碰到需要安慰人的时候。别人咳嗽，他不问病情，只把窗关上一条缝；有人加班，他会把最后一班邮车的时间写在废信封背面，悄悄压到对方杯子下面。每周五，他仍会把退信柜最后一格清空，说要给‘明天来的那一封’留地方。大家听了二十多年，最后都把这句话当成他的口头禅。"
    ],
    "玛戈·福格尔": [
      "玛戈做事很快，越紧张反而越安静。她削苹果喜欢让果皮从头到尾不断，洗杯子时会用拇指沿杯口摸一圈，确认没有茶渍才放回架上。她不爱欠人东西，哪怕只是半张车票或一把伞，也会在第二天想办法还回去。",
      "在家里，她很少叫赫尔曼的名字，更多时候仍叫‘局长’，像一个用了太久、已经很难改口的称呼。有人拿这件事开玩笑，她会笑一下，却不解释。她买东西习惯买得很精确：面包按人数，咖啡按天数，鲜奶会提前一天记在小纸片上。那些纸片大多被她随手夹进账本，边角压得平平整整。"
    ],
    "利奥波德·哈斯": [
      "哈斯的坏脾气在镇上很有名。他嫌病人把‘有一点疼’说得太含糊，也嫌年轻医生写字像在逃跑；可给孩子听诊前，他总会先把金属听筒在掌心焐热。诊金付不起的人会被他骂两句，然后名字出现在一本从不催收的薄册里。",
      "他每天关门前擦药秤，连秤盘边缘都不放过。写处方时速度很快，遇到小数点却会明显停一下，笔尖在纸上落得比别处重。学徒问他为什么这么认真，他只说：‘小东西最会惹大麻烦。’说完又嫌这句话像格言，第二天便不肯承认自己说过。"
    ],
    "维克托·莱茵": [
      "维克托在住宿簿上写‘邮票商’，衣袖却常带着黄铜和机油混在一起的味道。他每天清晨喝一杯不加糖的黑咖啡，喝完把杯柄转回右侧，再把硬币压在碟子下面。旅店女主人说，他从不让椅子歪着离开桌边。",
      "修机器时，他不喜欢别人替他递零件。拆下来的螺丝按长短排在手帕上，垫圈另放一列；少了一枚，他会从头数第二遍。有人问他年轻时做什么，他通常只回答‘靠手吃饭’。再问下去，他会开始谈天气、火车或某种已经停产的邮票，转弯转得很自然。"
    ],
    "安娜·韦伯": [
      "安娜留下的私人文字很少写自己。她记玛戈的鞋带总有一边系得更紧，记牛奶煮沸后锅沿会留下白色薄膜，记冬天第一场雪落在窗台以后，孩子会拿指尖去量积雪有多厚。病痛偶尔出现，也往往只有一句，然后便让位给明年的计划。",
      "她喜欢把还没有发生的事写得很具体：天气暖时去河堤看船，生日做少糖的杏酱，春天换一双不会磨脚的新鞋。纸页越往后，字迹越轻，计划却没有因此变少。她似乎相信，只要把日子写下来，明天就会先在纸上拥有一个位置。"
    ],
    "艾尔莎·克劳斯": [
      "艾尔莎年轻时想去剧院做服装，后来因为父亲生病留在邮局，一留就是三十多年。她说话快，记尺寸尤其准，把同事的手套尺码写在旧邮资表背面；玛戈小时候总丢一只手套，她索性每年织三只。",
      "抄写阵亡通知时，她会在公文纸下面多垫一张废纸，怕钢笔尖划破薄页。下班以后，她总比别人多留十分钟：捡桌脚的橡皮筋、擦净墨水瓶口、把水壶里的隔夜水倒掉。她不太会安慰人，别人哭时往往只把手帕递过去，再找一件不急的工作陪着做。"
    ]
  };

  const adaProfile = `<div class="note-entry person patch-profile"><b>艾达·克莱因</b>
    <p>艾达做过战地医生。右腕留下的旧伤在阴冷天气里会发紧，所以她用放大镜时总以左手托住右腕，像给自己的手腕临时加一道支架。她从不把这个动作解释成坚强或忍耐，只说“这样看得稳一点”。</p>
    <p>询问时，她很少在别人停顿后立刻追问。有人把这种沉默当成技巧，她在私人笔记里却写得很普通：人在找词的时候，不要替他把词递过去。她的本子常分成两栏，一边写“知道”，另一边写“不知道”；空白可以留很多天，字却很少被事后改得更漂亮。</p>
    <p>生活里的艾达并不严肃。她喝咖啡总忘记趁热，口袋里常有薄荷糖，雨天会先看门口有没有地方挂湿外套。她不喜欢别人称她为“天才调查员”，理由是这个词听起来像不用复查。有人问她最信任什么，她想了想，说：“第二遍。”</p>
    <small>人物生活补录 · 非证物</small></div>`;

  const snowBeforePages = {
    1:{title:"雨里的孩子",copy:`<p>小站从傍晚开始下雨。雨丝先落在煤灰色的铁轨上，很快又把站台边缘洗得发亮。女孩坐在第六站台最里面的长椅，雨靴大了一码，脚一晃，鞋跟便从湿袜子后面松出来。她仍不肯脱，说母亲讲过，下雨天把脚弄湿，第二天就会发烧。</p><p>每有一列车靠站，她都站起来，把被坐皱的裙角抻平。车门打开，人群带着伞和皮箱涌下来，她踮起脚往后看，等最后一个乘客走过，才去问检票员：“这一趟有从南边来的人吗？”起初检票员还翻名单，后来只远远朝她摇头。女孩点一下头，重新坐回原处，仿佛下一趟车仍值得认真等。</p><p>末班车走后，站里只剩雨声、煤炉里偶尔塌下去的一小块火和墙上那只走得不太准的钟。穿邮政制服的男人从办公室出来，先把自己的伞递过去，又觉得伞柄太高，便把伞往下压了压。他没有说“别等了”，也没有问她为什么一个人。只把一双干手套塞进她怀里，说：“先去把鞋烤干。明天如果还想来，我陪你再等一次。”</p><p>女孩跟着他走到站门口，又忽然回头。长椅上留下一个浅浅的水印，像一个没有起身的人仍坐在那里。雨把远处的灯揉成模糊的金色。那一夜，她第一次觉得“明天”不是日历上的下一格，而是一盏还没有熄掉的灯。</p>`},
    2:{title:"每年一封",copy:`<p>后来，每到生日，女孩都会收到一封信。信里几乎不写“想你”，写的都是些不值得郑重保存的小事：窗台第一场雪比去年早了三天，厨房的牛奶又烧糊了，院子里的灰雀学会从晾衣绳上倒着啄面包屑；还写她小时候总把左脚鞋带系得太紧，走半天以后，脚背会留下一道红印。</p><p>起初她会把一封信读两遍。第一遍读得快，第二遍把纸压在桌面，用手指沿着每一行慢慢走。再大一点，她只读一遍，也不再当着别人拆。信被折成相同大小，藏在床板下方一个旧饼干盒里。冬天取出来时，纸会带着木头和樟脑混在一起的味道。</p><p>邮局长每次把信递给她，都像递一件再普通不过的公文。他会先问今天有没有上课，再问鞋是不是又磨脚，最后才说：“有你的。”有一年女孩突然问，为什么寄信人从来不写回邮地址。男人正给挂号信盖戳，木槌停在半空，停得并不久。他说：“她住得不太定。”随后把邮戳朝下，把信推过桌面。</p><p>很多年后，女孩已经记不起每封信的完整句子，却仍记得那些细枝末节：一只烧焦的奶锅，一场比往年早来的雪，一双总被系得太紧的鞋。人有时靠这些不重要的东西认出爱，因为真正重要的话太重，常常被留到下一封、下一年，或者某个大家都以为一定会到来的明天。</p>`},
    3:{title:"被雨洗淡的地方",copy:`<p>故事里有一位镇医生，冬天出诊总提着黑色皮箱。箱角被磕得发白，黄铜扣却擦得很亮。他写字极快，药名常常连成一条倾斜的线，只有遇到很小的数字时会慢下来。笔尖落在纸上，先停一下，再继续往前走，像一个急性子的人忽然记起有件事不能着急。</p><p>那一年雨很多。女人床边的窗框已经发胀，关到最后总会留一条细缝。夜里雨水顺着玻璃往下爬，一滴落在处方角上，把墨迹洇开。第二天医生把那张纸举到灯下，看了很久，没有发火，只把眼镜摘下来，用袖口擦了一遍，再戴回去。</p><p>孩子记得的是那块湿过的纸，而不是纸上的数字。墨水在那里变得很淡，像一句话说到最要紧的地方忽然压低了声音。大人们后来讲过很多遍，她也听过很多遍，可时间一久，她脑中留下的反而只有那片空白：一小块被雨水洗过的地方，比四周更白。</p><p>纸上的一个点很轻，轻得一滴水就能把它带走。可人会替空白添上重量。一个没有看清的数字，一句没有听完整的话，一次大人以为孩子已经睡着的争论，都可能在记忆里慢慢长出边缘。等到很多年以后，人甚至很难分清，自己记得的究竟是当时发生的事，还是后来一遍遍想起它时留下的形状。</p>`},
    4:{title:"改姓的人",copy:`<p>女孩长大以后改了姓。登记员把新证件从窗口下递出来，她先看名字，再看姓氏，最后用拇指摸了摸纸边，说：“没有错。”回去的路上，男人问她要不要再想想。她把证件塞进大衣内袋，反问：“有什么好想的？大家早就这么叫了。”</p><p>那天晚饭是土豆汤。屋外有风，厨房窗框一直轻轻响。男人把盐递过去，又收回来，像原本要说别的。女孩低头切面包，忽然问：“你替一个不在的人留这么多年东西，不累吗？”男人的勺子碰到碗沿，发出很轻的一声。他说：“我不是替她留。”女孩抬起头：“那替谁？”</p><p>他没有立刻回答。水壶在炉子上冒着细气，窗玻璃蒙了一层白。过了一会儿，他说：“替还会来取的人。”说完便起身去关小火，仿佛这句话只是一件厨房里的小事。女孩也没有再问，把最后一片面包掰成两半，其中一半推到他那边。</p><p>他们后来仍在同一张桌上吃饭。女孩在邮局里叫他“局长”，回到家偶尔也这么叫；男人听见，总会应一声，从不纠正。亲近有时并不长成一个新称呼，它也可能一直住在旧称呼里面，像一件穿了很多年的外套，袖口已经磨软，却没人舍得换。</p>`},
    5:{title:"雪落以前",copy:`<p>雪真正落下来以前，天会先静一阵。街上的风停了，屋檐下的水滴也像忘记往下掉。故事里的女孩在这样的夜里推开一扇门，看见桌上放着两只杯子，一只已经凉了，另一只还冒着很淡的热气。男人坐在灯下，手边压着一张写到一半的纸。</p><p>她先看那张纸，又看他的手。那双手她见过很多年：修过松动的门把，系过太大的雨靴，也在她小时候发烧时整夜摸过水壶的温度。可人在生气的时候，会突然不认识那些熟悉的东西。她问了一个等了太久的问题。男人张了张嘴，第一句话说得很轻，第二句话没有说完。</p><p>窗外开始落第一片雪。纸上留下几个开头，又被划去：<em>我本来…… / 那一年…… / 其实……</em>墨线压得很重，纸背都能摸出凹痕。女孩站了一会儿，最后只说：“你总觉得还有时间。”然后转身出去。门没有摔响，只是合上时带起一阵冷风，让桌边那封没有封口的信微微动了一下。</p><p>男人没有追出去。他坐回原处，把已经凉的那只杯子端起来，又放下。雪越下越密，街道慢慢失去颜色。页脚只剩一行很浅的铅笔字，像写作者在许久以后又回来补过：<em>明早把面包切薄一点。</em></p>`},
    6:{title:"收件人",copy:`<p>最后一页没有印刷页码，也没有装订孔。纸比前面的几页新一些，折成信封大小以后又被展开，折痕坚硬，像只经过一个夜晚。纸的正面没有地址，只有一个名字。写字的人显然写得很慢，每一笔都比平日更直。</p><p>他没有先写那些最难说的话，而是从厨房写起：黑麦面包还剩两片，咖啡足够煮一壶，明早的鲜奶已经有人订了。他写天气，写窗缝，写某个人小时候睡在邮袋中间，木槌一响就会皱眉。写到这里，他停了很久，墨在句尾积成一个稍深的小点。</p><p>有些人一辈子擅长替别人保存东西：退回来的信、忘在柜台的钥匙、孩子长大后未必还需要的旧围巾。他们以为保存就是一种表达，仿佛只要东西没有丢，里面的话也不会过期。可话和牛奶不一样，不能因为放在阴凉处，就永远等得到有人来取。</p><p>纸页最后没有漂亮的句子。只有一句很普通的话，普通得像一张早餐桌旁随口说出的安排。它没有被寄出，也没有来得及被当面说完。后来有人把这张纸展开时，窗外已经是另一个季节。收件人的名字仍清清楚楚，只有那个原本预备拿来说话的明天，再也找不到地址。</p>`}
  };

  let archiveWriting = false;
  function currentArchivePage(){
    const text = $("archive-page-no")?.textContent || "";
    const m = text.match(/第\s*(\d+)\s*叶/);
    if (m) return Number(m[1]);
    const active = document.querySelector("#archive-tabs .archive-tab.active");
    if (active) return [...active.parentElement.children].indexOf(active) + 1;
    return 1;
  }

  function enrichSnowBeforePage(){
    ...
    const enhanced = snowBeforePages[page];
    if (!enhanced) return;
    if (copy.dataset.literaryEnhanced === String(page) && copy.innerHTML === enhanced.copy) return;
    archiveWriting = true;
    title.textContent = enhanced.title;
    copy.innerHTML = enhanced.copy;
    copy.dataset.literaryEnhanced = String(page);
  ...
  function enrichNotebookAfterOriginal() {
    ...
    box.querySelectorAll(".note-entry.person").forEach(entry => {
      ...
      const extras = profileSupplements[name];
      if (!extras || entry.dataset.profileExpanded === "1") return;
      extras.forEach(text => {
        const p = document.createElement("p");
      ...
      entry.dataset.profileExpanded = "1";
    });
  ...
  document.addEventListener("click", (e) => {
    ...
    if (e.target.closest("#archive-btn") || e.target.closest("#archive-tabs .archive-tab")) {
      requestAnimationFrame(() => requestAnimationFrame(enrichSnowBeforePage));
    }
  }, true);
  ...
  function initContentObservers() {
    ...
    if (pageNo) new MutationObserver(() => requestAnimationFrame(enrichSnowBeforePage)).observe(pageNo,{childList:true,subtree:true,characterData:true});
    ...
    if (people) {
      ...
      new MutationObserver(() => {
        if (scheduled) return;
        scheduled = true;
        requestAnimationFrame(() => { scheduled = false; enrichNotebookAfterOriginal(); });
      }).observe(people,{childList:true,subtree:false});
    }
  }
  ...
  function init() {
    ...
    enrichSnowBeforePage();
    enrichNotebookAfterOriginal();
